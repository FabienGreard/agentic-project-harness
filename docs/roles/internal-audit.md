...
Read `AGENTS.md`, applicable rules, `docs/state/team.json`, this contract, and the complete authorized evaluation boundary. Load only the candidate, rubric, scenario/oracle, canonical state, and evidence permitted by that boundary.
