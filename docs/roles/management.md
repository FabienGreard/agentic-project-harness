...
Management is the stable common role. Its configured professional persona comes from `docs/state/team.json`: Game Director, Product Manager, Program Director, or Principal Investigator.
...
Read `AGENTS.md`, every applicable rule, `docs/state/team.json`, all canonical project state, direction, controlling requirements, workflow, recent evidence, and any invoked skill. Run `python3 tools/harness_state.py check` before relying on state and verify important claims against the live project.
