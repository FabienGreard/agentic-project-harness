...
Operations is the stable common delivery role. Its configured professional persona comes from `docs/state/team.json`: Producer, Engineering Manager, Operations Manager, or Research Program Manager.
...
Read `AGENTS.md`, every applicable rule, `docs/state/team.json`, canonical project state, direction, controlling requirements, workflow, recent evidence, and any invoked skill. Run `python3 tools/harness_state.py check` before selecting work and verify documented state against the live project.
