...
Codex discovers each skill through an individual `.agents/skills/<name>` link to `.baton/skills/<name>`. The `.baton/skills` tree is the only copy; do not create `.codex/skills` or a duplicated skill tree.
